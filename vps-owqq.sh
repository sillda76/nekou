...
show_menu() {
    clear  # 每次显示菜单时清屏
    echo -e "${BLUE}╔════════════════════════════════════════╗${NC}"
    echo -e "${BLUE}║${CYAN}          VPS 管理脚本                 ${BLUE}║${NC}"
    echo -e "${BLUE}╠════════════════════════════════════════╣${NC}"
    echo -e "${BLUE}║${GREEN} 1. 修改 SSH 端口${NC}        ${GREEN} 2. 系统更新${NC}        ${BLUE}║${NC}"
    echo -e "${BLUE}║${GREEN} 3. 系统清理${NC}            ${GREEN} 4. 安装/管理 Fail2Ban${NC} ${BLUE}║${NC}"
    echo -e "${BLUE}║${GREEN} 5. 开启/关闭禁 Ping${NC}     ${GREEN} 6. 安装 SSH 系统信息${NC}  ${BLUE}║${NC}"
    echo -e "${BLUE}║${CYAN} 00. 更新脚本${NC}            ${CYAN} 99. 卸载脚本${NC}         ${BLUE}║${NC}"
    echo -e "${BLUE}║${RED} 0. 退出脚本${NC}                                      ${BLUE}║${NC}"
    echo -e "${BLUE}╚════════════════════════════════════════╝${NC}"
}
